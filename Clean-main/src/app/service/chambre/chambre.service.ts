...
export class ChambreService {
  ...
  private nombreChambressSubject: BehaviorSubject<number> = new BehaviorSubject<number>(0);
  nombreChambress$: Observable<number> = this.nombreChambressSubject.asObservable();
  ...
  getAllChambress(): Observable<Chambres[]> {
    return this._http.get<Chambres[]>(this.apiServer + 'getAllChambres', this.httpOptions);
  }
  ...
  deleteChambres(idChambres: number): Observable<any> {
    return this._http.delete(`${this.apiServer}deleteChambre/${idChambres}`, this.httpOptions)
  }

  updateChambres(Chambres: Chambres): Observable<Chambres> {
    return this._http.put<Chambres>(`${this.apiServer}updateChambre`, Chambres, this.httpOptions);
  }

  createChambres(Chambres: Chambres) {
    return this._http.post<Chambres>(this.apiServer + 'addChambre', Chambres, this.httpOptions)
  }
  getcountChambres(){
  ...
  getBlocByIdChambre<Bloc>(id:number){
    return this._http.get<Bloc>("http://localhost:8080/TpEtudeDeCas/bloc/"+id);
  }
