...
export class BlocService {
  ...
  private baseUrl ="http://localhost:8080/TpEtudeDeCas/bloc"
  ...
  getFoyers(): Observable<Foyer[]>{
    return this.http.get<Foyer[]>("http://localhost:8080/TpEtudeDeCas/foyer/getAllFoyers");
  }

  getFoyerById(id:number | undefined): Observable<Foyer>{
    return this.http.get<Foyer>("http://localhost:8080/TpEtudeDeCas/foyer/"+id);
  }

  getAllUnassignedChambres(): Observable<Chambre[]>{
    return this.http.get<Chambre[]>("http://localhost:8080/TpEtudeDeCas/chambre/unassigned");
  }
